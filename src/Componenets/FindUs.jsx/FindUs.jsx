...
const FindUs = () => {
  return (
    <div>
      ...
      {/* Facebook */}
      <a href='https://www.facebook.com/sharer/sharer.php?u=https://example.com/news/123' target='_blank'>
        <div className='border border-base-300 p-5 flex items-center gap-4'>
      ...
      {/* Twitter */}
      <a href='https://twitter.com/intent/tweet?url=https://example.com/news/123&text=Check%20this%20out!' target='_blank'>
        <div className='border border-base-300 p-5 flex items-center gap-4'>
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
            <rect width="30" height="30" rx="15" fill="#F3F3F3" />
          ...
          <p className='text-accent font-semibold'>Twitter</p>
        </div>
      </a>
      ...
      <a href='https://www.instagram.com/yourprofile' target='_blank'>
        <div className='border border-base-300 p-5 flex items-center gap-4'>
          ...
          <p className='text-accent font-semibold'>Instagram</p>
        </div>
      </a>
    </div>
  );
